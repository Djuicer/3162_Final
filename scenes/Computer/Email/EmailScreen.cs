...
public partial class EmailScreen : Control
{
	...
	private void OnAttendPartyPressed()
	{
		...
		state.Attributes.IncreaseNetworking(5);
		state.PartyAttended = true;
		state.PartyNetworkingUnlocked = true;
		_attendPartyButton.Visible = false;
		_statusLabel.Text = "You attended the dance party. You met a few classmates and felt more connected. A full dialogue event will be added later.";
	}
}
