...
public partial class ComputerLab : Node2D
{
	...
	public override void _Ready()
	{
		...
		_pcInteractArea = GetNodeOrNull<Area2D>("ComputerLabPC/InteractionArea");
	...
	private void TryStartStudyCs()
	{
		...
		TransitionManager.Instance?.ChangeSceneToFileWithFade("res://scenes/Minigames/FocusCatch/focus_catch.tscn");
	}
